...
import './SwitcherPor.sass'
import store from '../../Store'

@observer
export default class SwitcherPor extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      ...
      <div className='project-switcherpor'>
        <Link to='/' className='project-switcherpor-btn close'>
          <div className='cross cross1'></div>
          <div className='cross cross2'></div>
        </Link>
          <div className='project-switcherpor-title--container'>
          <div className='project-switcherpor-title'>{store[project].Header} - {store[project].Name}</div>
          </div>
        <Link to={store[project].Next} className='project-switcherpor-btn next'>
          <div className='arrow'>
        ...
        <Link to={store[project].Prev}  className='project-switcherpor-btn prev'>
          <div className='arrow'>
